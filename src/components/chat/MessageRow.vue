...
<template>
    <div class="message-row" :class="[message.role === 'user' ? 'right' : 'left']">
        ...
        <div class="row">
            ...
            <div class="message">
                ...
                <MdPreview v-if="message.content" id="preview-only" :model-value="message.content"
                    preview-theme="smart-blue" :style="{
                        backgroundColor:
