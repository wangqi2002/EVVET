...
<template>
  <h2 color="$ep-color-primary">
    electron + Vite + Vue3 + element plus + TypeScript
  </h2>

  <p>
    See
    <a href="https://chat.deepseek.com/" target="_blank">AI-Assistant! EVVET</a>
  ...
  <p>For example, we can custom primary color to 'blue'.</p>
